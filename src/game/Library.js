...
export default function Library() {
  ...
  return (
    <>
      ...
      <LazyLoad>
      <div className="xyz1">
        <img src={"https://github.com/TAdS-VCT/Media/blob/main/riddles/Library/harry%20book.png?raw=true"} alt="hii" className='vectors lib1' onClick={handlecorrect} aria-hidden="true" />
        <img src={"https://github.com/TAdS-VCT/Media/blob/main/riddles/Library/eyeglasses.png?raw=true"} alt="hii" className='vectors lib2' onClick={handlewrong3} aria-hidden="true" />
        <img src={"https://github.com/TAdS-VCT/Media/blob/main/riddles/Library/open%20book%20front%20view.png?raw=true"} alt="hii" className='vectors lib3' onClick={handlewrong5} aria-hidden="true" />
        <img src={"https://github.com/TAdS-VCT/Media/blob/main/riddles/Library/flowervase-01.png?raw=true"} alt="hii" className='vectors lib4' onClick={handlewrong4} aria-hidden="true" />
        {/* <img src={v1} alt="hii" className='vectors lib5' onClick={handlewrong1} aria-hidden="true" /> */}
        <ToastContainer />
      </div>
      </LazyLoad>
    </>
